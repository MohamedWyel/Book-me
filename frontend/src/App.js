      ...
      <div className={darkMode ? "bg-black text-light" : "bg-white text-dark"}>
        ...
        >
          <div className="container">
            ...
            >
              <img
                src="bookme-logo-grayscale-transparent.png"
                alt="BookMe Logo"
              ...
              <div className="d-flex align-items-center gap-2">
                {username ? (
                  <>
                    <Link
                      to="/profile"
                      className="text-decoration-none text-warning fw-semibold me-2"
                    >
                      👋 {username}
                    </Link>
                    <button
        ...
        <Routes>
          ...
          <Route
            path="/register"
            element={<Register setUsername={setUsername} darkMode={darkMode} />}
          />
          <Route
            path="/hotels"
            element={<Hotels setUsername={setUsername} darkMode={darkMode} />}
          />
          <Route
            path="/hotels/:id"
            element={
              <HotelDetails setUsername={setUsername} darkMode={darkMode} />
            }
          />
          <Route
            path="/profile"
            element={<Profile darkMode={darkMode} setUsername={setUsername} />}
          />
          <Route
            path="/books"
            element={<Books darkMode={darkMode} setUsername={setUsername} />}
          />
          <Route
            path="/cancel-booking/:id"
            element={
              <CancelBooking darkMode={darkMode} setUsername={setUsername} />
            }
          />
          <Route path="/rooms/:id" element={<Rooms darkMode={darkMode} />} />
          <Route path="/book/:roomId" element={<Book darkMode={darkMode} />} />
        </Routes>
      </div>
    </Router>
  );
